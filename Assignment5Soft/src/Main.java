        ...
        while (true) {
            ...
            if (choice.equals("1")) {
                ...
                switch (opt) {
                    ...
                    case "5": light.turnOn(); break;
                    case "6": light.turnOff(); break;
                    case "7": musicSystem.play(); break;
                    case "8": musicSystem.stop(); break;
            ...
            if (choice.equals("2")) {
                ...
                while (true) {
                    ...
                    if (cmd.equals("light on")) light.operate();
                    else if (cmd.equals("light off")) light.turnOff();
                    else if (cmd.equals("music on")) musicSystem.operate();
                    else if (cmd.equals("music off")) musicSystem.stop();
